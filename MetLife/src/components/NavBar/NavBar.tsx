...
import dropDown from '../../assets/images/dropDown.webp';
      ...
      <div className="fixed top-0 w-full shadow-md bg-white  ">
        <div className="flex items-center justify-between px-6 h-19">
          ...
          <div className="flex items-center gap-10">
            <img className="h-7 md:block hidden cursor-pointer" onClick={()=>navigate('/dashboard')} src={metLife} />
            ...
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              <img className="h-4 w-4" src={dropDown} />
            </div>
